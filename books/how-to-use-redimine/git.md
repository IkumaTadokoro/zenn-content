...
Githubを開かずに、RubyMine上からPull Requestを作成することが可能です。
...
以下の設定ができるので、適宜設定してOKを選択することで、Gistを作成することができます。
ちょっとしたソースコードを誰かにみてもらいたいときなどに重宝します。

## Githubで開く

ファイルをGithubで参照する際に、Github上でファイルを探していく他に、RubyMineから直接開くこともできます。


## stash

InteliJ系IDEの共通機能としてshelvsというものもあるのですが、全然使わないので今回は割愛します。
